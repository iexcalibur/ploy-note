...
export function useSeedSampleData() {
  ...
  useEffect(() => {
    ...
    if (spaceService.spaces$.value.length > 0) return;
    ...
    // Side Projects
    addMemory(sideProjectsId, 'Project A uses React + TypeScript + BlockSuite');
    ...
    addDump('text', 'Check out that new VS Code extension for AI code review', {
